...
type ReviewServiceErrorReason int32

const (
	ReviewServiceErrorReason_UNKNOWN_ERROR  ReviewServiceErrorReason = 0
	ReviewServiceErrorReason_LOGIN_FAILED   ReviewServiceErrorReason = 1
	ReviewServiceErrorReason_DB_FAILED      ReviewServiceErrorReason = 2
	ReviewServiceErrorReason_ORDER_REVIEWED ReviewServiceErrorReason = 10
)

// Enum value maps for ReviewServiceErrorReason.
var (
	ReviewServiceErrorReason_name = map[int32]string{
		0:  "UNKNOWN_ERROR",
		1:  "LOGIN_FAILED",
		2:  "DB_FAILED",
		10: "ORDER_REVIEWED",
	}
	ReviewServiceErrorReason_value = map[string]int32{
		"UNKNOWN_ERROR":  0,
		"LOGIN_FAILED":   1,
		"DB_FAILED":      2,
		"ORDER_REVIEWED": 10,
...
func (x ReviewServiceErrorReason) Enum() *ReviewServiceErrorReason {
	p := new(ReviewServiceErrorReason)
	*p = x
	return p
}

func (x ReviewServiceErrorReason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ReviewServiceErrorReason) Descriptor() protoreflect.EnumDescriptor {
	return file_api_review_v1_review_error_proto_enumTypes[0].Descriptor()
}

func (ReviewServiceErrorReason) Type() protoreflect.EnumType {
	return &file_api_review_v1_review_error_proto_enumTypes[0]
}

func (x ReviewServiceErrorReason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ReviewServiceErrorReason.Descriptor instead.
func (ReviewServiceErrorReason) EnumDescriptor() ([]byte, []int) {
...
var file_api_review_v1_review_error_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2a, 0x74, 0x0a, 0x18, 0x52, 0x65, 0x76, 0x69, 0x65, 0x77,
	...
	0x52, 0x4f, 0x52, 0x10, 0x00, 0x12, 0x10, 0x0a, 0x0c, 0x4c, 0x4f, 0x47, 0x49, 0x4e, 0x5f, 0x46,
	0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x01, 0x12, 0x13, 0x0a, 0x09, 0x44, 0x42, 0x5f, 0x46, 0x41,
	0x49, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x1a, 0x04, 0xa8, 0x45, 0xf4, 0x03, 0x12, 0x18, 0x0a, 0x0e,
	0x4f, 0x52, 0x44, 0x45, 0x52, 0x5f, 0x52, 0x45, 0x56, 0x49, 0x45, 0x57, 0x45, 0x44, 0x10, 0x0a,
	...
	0x17, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x72, 0x65, 0x76, 0x69,
	0x65, 0x77, 0x2f, 0x76, 0x31, 0x3b, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_api_review_v1_review_error_proto_goTypes = []interface{}{
	(ReviewServiceErrorReason)(0), // 0: api.review.v1.ReviewServiceErrorReason
}
